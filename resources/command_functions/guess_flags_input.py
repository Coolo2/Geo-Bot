...
async def start_game(client : client.Client, interaction : discord.Interaction, requestor : discord.Member):
    ...
    modal_input_box = discord.ui.InputText(style=discord.InputTextStyle.singleline, placeholder=lp.flagModalPlaceholder, label=lp.flagModalLabel)
